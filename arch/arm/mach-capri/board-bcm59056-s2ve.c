...
/* This table is default data, the real data from board file or device tree*/
	{.temp = -200,
	 .reset = 0, .fct = 324, .guardband = 100,
	 .esr_vl_lvl = 3691, .esr_vm_lvl = 3817, .esr_vh_lvl = 4045,
	 .esr_vl_slope = -43830, .esr_vl_offset = 163309,
	 .esr_vm_slope = -4301, .esr_vm_offset = 17396,
	 .esr_vh_slope = 421, .esr_vh_offset = -626,
	 .esr_vf_slope = -2199, .esr_vf_offset = 9972,
	 .vcmap = &batt_voltcap_map[0],
	 .maplen = ARRAY_SIZE(batt_voltcap_map)},/* -20 */
	{.temp = -150,
	 .reset = 0, .fct = 489, .guardband = 100,
	 .esr_vl_lvl = 3691, .esr_vm_lvl = 3817, .esr_vh_lvl = 4045,
	 .esr_vl_slope = -43830, .esr_vl_offset = 163309,
	 .esr_vm_slope = -4301, .esr_vm_offset = 17396,
	 .esr_vh_slope = 421, .esr_vh_offset = -626,
	...
	{.temp = -100,
	 .reset = 0, .fct = 654, .guardband = 100,
	 .esr_vl_lvl = 3687, .esr_vm_lvl = 3714, .esr_vh_lvl = 3837,
	 .esr_vl_slope = -799, .esr_vl_offset = 4088,
	 .esr_vm_slope = -9489, .esr_vm_offset = 36126,
	 .esr_vh_slope = -1998, .esr_vh_offset = 8302,
	 .esr_vf_slope = -544, .esr_vf_offset = 2724,
	 .vcmap = &batt_voltcap_map[0],
	 .maplen = ARRAY_SIZE(batt_voltcap_map)},/* -10 */
	{.temp = -50,
	 .reset = 0, .fct = 770, .guardband = 100,
	 .esr_vl_lvl = 3687, .esr_vm_lvl = 3714, .esr_vh_lvl = 3837,
	 .esr_vl_slope = -799, .esr_vl_offset = 4088,
	 .esr_vm_slope = -9489, .esr_vm_offset = 36126,
	 .esr_vh_slope = -1998, .esr_vh_offset = 8302,
	...
	{.temp = 0,
	 .reset = 0, .fct = 887, .guardband = 100,
	 .esr_vl_lvl = 3654, .esr_vm_lvl = 3689, .esr_vh_lvl = 3837,
	 .esr_vl_slope = 542, .esr_vl_offset = -1240,
	 .esr_vm_slope = -3713, .esr_vm_offset = 14307,
	 .esr_vh_slope = -1750, .esr_vh_offset = 7064,
	 .esr_vf_slope = -254, .esr_vf_offset = 1325,
	 .vcmap = &batt_voltcap_map[0],
	 .maplen = ARRAY_SIZE(batt_voltcap_map)},/* 0 */
	{.temp = 50,
	 .reset = 0, .fct = 929, .guardband = 100,
	 .esr_vl_lvl = 3654, .esr_vm_lvl = 3688, .esr_vh_lvl = 3714,
	 .esr_vl_slope = 497, .esr_vl_offset = -1316,
	 .esr_vm_slope = -2968, .esr_vm_offset = 11343,
	 .esr_vh_slope = -3781, .esr_vh_offset = 14342,
	 .esr_vf_slope = -236, .esr_vf_offset = 1175,
	 .vcmap = &batt_voltcap_map[0],
	 .maplen = ARRAY_SIZE(batt_voltcap_map)},/* 5 */
	{.temp = 100,
	 .reset = 0, .fct = 971, .guardband = 30,
	 .esr_vl_lvl = 3654, .esr_vm_lvl = 3688, .esr_vh_lvl = 3714,
	 .esr_vl_slope = 497, .esr_vl_offset = -1316,
	 .esr_vm_slope = -2968, .esr_vm_offset = 11343,
	 .esr_vh_slope = -3781, .esr_vh_offset = 14342,
	...
	{.temp = 150,
	 ...
	 .esr_vl_lvl = 3654, .esr_vm_lvl = 3684, .esr_vh_lvl = 3691,
	 .esr_vl_slope = 401, .esr_vl_offset = -1088,
	 .esr_vm_slope = -2067, .esr_vm_offset = 7929,
	 .esr_vh_slope = -13673, .esr_vh_offset = 50684,
	 .esr_vf_slope = -130, .esr_vf_offset = 693,
	 .vcmap = &batt_voltcap_map[0],
	 .maplen = ARRAY_SIZE(batt_voltcap_map)},/* 15 */
	{.temp = 200,
	 .reset = 0, .fct = 1000, .guardband = 30,
