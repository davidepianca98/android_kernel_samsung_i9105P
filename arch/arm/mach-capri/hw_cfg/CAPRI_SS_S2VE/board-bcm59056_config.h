...
struct bcmpmu_regulator_init_data bcm59056_regulators[BCMPMU_REGULATOR_MAX] = {
	...
	[BCMPMU_REGULATOR_VIBLDO] = {
		BCMPMU_REGULATOR_VIBLDO, &bcm59056_vibldo_data, 0x02, BCMPMU_REGL_OFF_IN_DSM
	},
	...
	[BCMPMU_REGULATOR_SIM2LDO] = {
		BCMPMU_REGULATOR_SIM2LDO, &bcm59056_sim2ldo_data, 0x02, 0
	},
	...
	[BCMPMU_REGULATOR_CSR_NM] = {
		BCMPMU_REGULATOR_CSR_NM, &bcm59056_csr_data, 0x00, 0
	},
