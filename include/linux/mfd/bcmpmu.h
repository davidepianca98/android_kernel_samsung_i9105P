...
struct bcmpmu_reg_info {
	/* index of address of regulator control register for mode control */
	u32 reg_addr;
	/* second reg_addr for mode control */
	u32 reg_addr2;
...
extern struct regulator_ops bcmpmuHDMI_ops;
...
enum bcmpmu_reg {
	...
	PMU_REG_RTC_CALIB2,
	PMU_REG_RTC_CALIB3,
	PMU_REG_RFLDOPMCTRL1,
	PMU_REG_RFLDOPMCTRL2,
	PMU_REG_AUDLDOPMCTRL1,
	PMU_REG_AUDLDOPMCTRL2,
	PMU_REG_MICLDOPMCTRL1,
	PMU_REG_MICLDOPMCTRL2,
	PMU_REG_MMCLDO1PMCTRL1,
	PMU_REG_MMCLDO1PMCTRL2,
	PMU_REG_MMCLDO2PMCTRL1,
	PMU_REG_MMCLDO2PMCTRL2,
	PMU_REG_SIMLDO1PMCTRL1,
	PMU_REG_SIMLDO1PMCTRL2,
	PMU_REG_SIMLDO2PMCTRL1,
	PMU_REG_SIMLDO2PMCTRL2,
	PMU_REG_CAMLDO1PMCTRL1,
	PMU_REG_CAMLDO1PMCTRL2,
	PMU_REG_CAMLDO2PMCTRL1,
	PMU_REG_CAMLDO2PMCTRL2,
	PMU_REG_SDLDOPMCTRL1,
	PMU_REG_SDLDOPMCTRL2,
	PMU_REG_SDXLDOPMCTRL1,
	PMU_REG_SDXLDOPMCTRL2,
	PMU_REG_VIBLDOPMCTRL1,
	PMU_REG_VIBLDOPMCTRL2,
	PMU_REG_CSRPMCTRL1,
	PMU_REG_CSRPMCTRL2,
	PMU_REG_CSRPMCTRL3,
	PMU_REG_CSRPMCTRL4,
	...
	PMU_REG_GPLDO5CTRL,
	PMU_REG_GPLDO6CTRL,
	PMU_REG_GPLDO1PMCTRL1,
	PMU_REG_GPLDO1PMCTRL2,
	PMU_REG_GPLDO2PMCTRL1,
	PMU_REG_GPLDO2PMCTRL2,
	PMU_REG_GPLDO3PMCTRL1,
	PMU_REG_GPLDO3PMCTRL2,
	PMU_REG_GPLDO4PMCTRL1,
	PMU_REG_GPLDO4PMCTRL2,
	PMU_REG_GPLDO5PMCTRL1,
	PMU_REG_GPLDO5PMCTRL2,
	PMU_REG_GPLDO6PMCTRL1,
	PMU_REG_GPLDO6PMCTRL2,
	PMU_REG_ENV1,
	PMU_REG_ENV2,
	PMU_REG_ENV3,
	PMU_REG_ENV4,
	...
	PMU_REG_HIGH_GAIN_MODE_HSL,
	PMU_REG_HIGH_GAIN_MODE_HSR,
	...
	PMU_REG_OTG_ROTG_VBUS,
	PMU_REG_OTG_ENABLE,
	PMU_REG_ID_DET_ENABLE,
	PMU_REG_OTG_SESS_VALID_COMP,
	PMU_REG_OTG_VBUS_VALID_COMP,
	PMU_REG_ADP_SENSE,
	...
	/* USB LDO PM CTRL */
	PMU_REG_USBLDOPMCTRL1,
	PMU_REG_USBLDOPMCTRL2,

	/* IO Switch PM CTRL*/
	PMU_REG_IOSR1PMCTRL1,
	PMU_REG_IOSR1PMCTRL2,
	PMU_REG_IOSR2PMCTRL1,
	PMU_REG_IOSR2PMCTRL2,
	PMU_REG_MAX,
};
enum bcmpmu_irq_reg {
	PMU_REG_INT1,
...
enum bcmpmu_chrgr_curr_limits_t {
	PMU_CHRGING_CURR_MIN = 50,
	PMU_CHRGING_CURR_MAX = 1550
};
...
enum bcmpmu_usb_id_lvl_t {
        PMU_USB_ID_GROUND,//id_ground should be zero
        PMU_USB_ID_B_DEVICE,
	PMU_USB_ID_NOT_SUPPORTED,
	PMU_USB_ID_RID_A,
	PMU_USB_ID_RID_B,
	PMU_USB_ID_RID_C,
        PMU_USB_ID_NOT_SUPPORTED2,
	PMU_USB_ID_FLOAT,
        PMU_USB_ID_MAX,
};
...
enum bcmpmu_event_t {
	...
	BCMPMU_CHRGR_UBPD_CHG_F,
	/* external charger events */
	BCMPMU_EXTCHRGR_EVENT_DETECTION,
	BCMPMU_EVENT_MAX,
};
...
enum bcmpmu_usb_ctrl_t {
	...
	BCMPMU_USB_CTRL_ENABLE_ID_DETECT,
	...
	BCMPMU_USB_CTRL_SET_SESS_COMP,
	BCMPMU_USB_CTRL_SET_VBUS_VALID_COMP,
	BCMPMU_USB_CTRL_SET_ROTG_VBUS,
...
struct bcmpmu_usb_accy_data {
	...
	int batt_present;
	int usb_dis;
	int ext_chrgr_present;
};

struct bcmpmu_ext_chrgr_info {
	int ac5v;
	int iusb;
	int cen;
	int usus;
...
#endif
	int support_die_temp_monitor;
	int die_temp_threshold;
	int die_temp_hysteresis;
	int die_temp_throttle;
	int die_temp_slope;
	int die_temp_offset;
	int adc_rtm_for_hk;
	int ntc_upper_boundary;
	int adc_channel_ntc;
	int adc_channel_patemp;
	int adc_channel_32ktemp;
};
