...
*
****************************************************************************/
void extern_bt_sel_audio_route(int gpio_val)
{
	if (ext_aud_plat_cfg.bt_sel_aud_route_gpio > 0)
		audio_gpio_output("BT_SEL_ROUTE",
			ext_aud_plat_cfg.bt_sel_aud_route_gpio, gpio_val);
}
#endif
